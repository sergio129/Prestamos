 ...
 * Proporciona cálculos y simulaciones avanzadas
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    advancedModal.innerHTML = `
        <div class="modal-content">
            ...
            <div class="tabs">
                <div class="tab active" data-tab="capacidad-pago">Capacidad de pago</div>
                <div class="tab" data-tab="prestamo-maximo">Préstamo máximo</div>
                <div class="tab" data-tab="comparativa">Comparativa</div>
            </div>
            
            <div class="tab-content">
                <!-- Capacidad de pago -->
                <div class="tab-pane active" id="capacidad-pago-tab">
                ...
                <!-- Préstamo máximo -->
                <div class="tab-pane" id="prestamo-maximo-tab">
                ...
                <!-- Comparativa -->
                <div class="tab-pane" id="comparativa-tab">
    ...
    // Cerrar modal
    advancedModal.querySelector('.close-modal').addEventListener('click', function() {
        advancedModal.classList.add('hidden');
    });
    
    // Cambio de pestañas
    advancedModal.querySelectorAll('.tab').forEach(tab => {
        tab.addEventListener('click', function() {
            // Desactivar todas las pestañas
            advancedModal.querySelectorAll('.tab').forEach(t => {
                t.classList.remove('active');
            });
            
            // Desactivar todos los paneles
            advancedModal.querySelectorAll('.tab-pane').forEach(p => {
